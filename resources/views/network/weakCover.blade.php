                    ...
                    <div class="box">
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <div class="btn-group">
                                    <a class="btn  btn-primary ladda-button" data-style="expand-right" onclick="doSearchData()" id="search">
            ...
            <div class="box">
                ...
                <div class="box-body">
                	<form class="form-inline" role='form'>
                		...
                		<div class="form-group">
                			<a id="search" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#" onClick="doSearchData()"><span class="ladda-label">查询</span></a>
                	    </div>
                	</form>
                </div>
                <div class="box-body">
...
<script type="text/javascript" src="dist/js/genius/weakCover.js"></script>