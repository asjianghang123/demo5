    ...
    <div class="row">
        <div class="col-md-12">
           ...
           <!--  <div class="box">
                ...
                <div class="box-body">
                    <div id="map1" style="position: relative;height: 400px;width:100%" ></div>
                </div>
            </div> -->
...
@section('scripts')
    ...
    <script>
        ...
        $.get('switch/getDate', function(data){
            var sdata = [];
        ...
        function initMap(mapId) {
            ...
            staticControl.prototype.initialize=function(map){
            	...
            	$("#search").click(function(){  
            		...
            		$.get('switch/switchOutTable', params, function(data){
        ...
        var drawMapOut = function (t) {
        	if(t == '最大RRC连接用户数'){
        		...
        		url = 'switch/wireLessLost';
        	}else if(t=='PUSCH上行干扰电平'){
        		url = 'switch/PUSCHInterfere';
        	}else if(t=='origin'){
        		url = "switch/switchData";
        	}
                        ...
                        drawOptions: { // 绘制参数
                            ...
                            events: {
                                click: function(e, data) {
                                    ...
                                    $.get('switch/switchDetail', params, function(data){
        ...
        function exportSwitchData() {
            ...
            E.start();
            $.post("switch/exportSwitchData", {date:date,cell:cell}, function(data){
                if (data.result) {
