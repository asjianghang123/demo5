                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" role="form" id="queryForm">
                                ...
                                <div class="form-group">
                                    <label for="interfepointDate" class="col-sm-2 control-label">日期</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="interfepointDate" id="interfepointDate">
                                        </input>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="interfepointHour" class="col-sm-2 control-label">小时</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="interfepointHour" id="interfepointHour">
                                ...
                                <div class="form-group">
                                    <label for="interfepointMinute" class="col-sm-2 control-label">分钟</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="interfepointMinute" id="interfepointMinute">
                                        	<option value='0'>0</option>
											<option value='15'>15</option>
                                ...
                                <div class="form-group">
                                    <label for="interfepointChannel" class="col-sm-2 control-label">频段</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="interfepointChannel" id="interfepointChannel" multiple="multiple">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="dimension" class="col-sm-2 control-label">维度</label>
                                    <div class="col-sm-10">
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <div class="btn-group">
                                    <span class="ladda-label" data-style="expand-right">
                                        <button class="btn btn-primary" type="button"  onclick="doInterfepointSearch()" id="interfepointSearch">查询</button>
                                    </span>
                                    <span class="ladda-label" data-style="expand-right">
                                        <button class="btn btn-primary" type="button"  onclick="drawMap(allCells)" id="refreshButton">刷新维度</button>
                                    </span>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="dist/js/genius/interPointCloud.js"></script>