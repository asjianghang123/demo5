		...
		<div class="col-sm-9">	
			<div class="box"> 
				...
				<div class="box-footer" style="text-align:right;">
					<a id="search" class="btn btn-primary ladda-button" data-style="expand-right">
						<span class="ladda-label">查询</span>
					</a>
					<a id="export" type="button" class="btn btn-primary ladda-button hidden" data-color='red' data-style="expand-right" onClick="doSearchLTE('file')">
