			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <div class="btn-group">
	                        <!-- <a class="btn btn-box-tool fa fa-wrench" href="GSMTemplateManage"></a> -->
	                        <a class="btn btn-primary" href="GSMTemplateManage"><span class="fa">管理</span></a>
                        </div>
                    </div>
				</div>
				...
				<div class="box-body">
					<form class="form-horizontal" role="form" id="queryForm">
						<div class="form-group">
                            ...
                            <div class="col-sm-4">
                            	<select id="locationDim" class="form-control input-sm">
									...
									<option value='erbs'>BSC</option>
									<option value='erbsGroup'>BSC组</option>
						...
						<div class="form-group">
							...
							<label class="col-sm-2 control-label" id="quarterLabel" style="display: none;">15分钟</label>
							<div class="col-sm-4" id="quarterDiv" style="display: none;">
					...
					<!-- <table class="table">
						...
						<tr>
							...
							<th>
								<div class="input-group input-group-md"  style="width:100%">
								<input id="endTime" class="form-control" type="text" value=""/>							</div>
							</th>
						</tr>
						<tr>
							<td>城市</td>
					...
					<input id="GSMQueryFile" value='' hidden="true">	
				</div>

				<div class="box-footer" style="text-align:right;">
					<a id="search" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" onClick="doSearchGSM('table')"><span class="ladda-label">查询</span></a>
					...
					<a id="export" class="btn btn-primary ladda-button hidden" data-color='red' data-style="expand-right" onClick="doSearchGSM('file')"><span class="ladda-label">导出</span></a> 
				</div>
...
<script type="text/javascript" src="dist/js/QueryAnalysis/GSMQuery.js"></script>