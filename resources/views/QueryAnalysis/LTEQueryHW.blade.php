				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <div class="btn-group">
	                        ...
	                        <a class="btn btn-primary" href="LTETemplateManageHW"><span class="fa">管理</span></a>
                        </div>
                    </div>
				</div>
				<div class="box-body">
				...
				<div class="box-body">     
					<form class="form-horizontal" role="form" id="queryForm">
						<div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="locationDim" class="form-control input-sm">
									<option value='city' disabled="disabled">城市</option>
									<option value='subNetwork' disabled="disabled">子网</option>
									<option value='subNetworkGroup' disabled="disabled">子网组</option>
							...
							<div class="col-sm-4">
								<select id="timeDim" class="form-control input-sm">
									...
									<option value='quarter' disabled="disabled">15分钟</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select id="subNetworks" class="form-control" multiple="multiple" disabled="disabled">
								</select>
							</div>
						</div>
						<div class="form-group">
...
<script type="text/javascript" src="dist/js/QueryAnalysis/LTEQuery_HW.js"></script>
