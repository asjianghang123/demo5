...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="NBIQuery">NBI指标查询</a>
		</li>
		<li class="active">NBI模板管理</li>
	</ol>
</section>
@endsection
@section('content')
		...
		<div class="col-sm-6">
			<div class='box'>
				...
				<div class="box-body">
					...
					<br />
					<div class="form-group"  style="height:500px;width:100%; overflow:auto;margin-top:34px" id="NBIFormulaTableDiv">
						<table id="NBIFormulaTable"></table>
					</div>
				</div>
			</div>	
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
					...
					<div class="form-group">
						<label class="col-sm-2 col-sm-offset-2 control-label">制式</label>
                        <div class="col-sm-4">
                            <select id="NBIFormat_kpi" class="form-control">
								<option>TDD</option>
								<option>FDD</option>
								<option>NBIOT</option>
							</select>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
					...
					<div class="form-group">
						<label class="col-sm-2 col-sm-offset-2 control-label">制式</label>
                        <div class="col-sm-4">
                            <select id="NBIFormat" class="form-control">
								<option>TDD</option>
								<option>FDD</option>
								<option>NBIOT</option>
							</select>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
					...
					<div class="form-group">
						<label class="col-sm-2 col-sm-offset-2 control-label">制式</label>
                        <div class="col-sm-4">
                            <select id="NBIFormat_copy" class="form-control">
								<option>TDD</option>
								<option>FDD</option>
								<option>NBIOT</option>
							</select>
...
<script type="text/javascript" src="dist/js/QueryAnalysis/NBITemplateManage.js"></script>
