			...
			<div class="modal-body col-sm-12">
				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="input-group">
		               ...
		               <input type="file" accept=".csv" class="hidden" name="fileImports" id="fileImports" onchange="toNames(this)">
		               <span class="input-group-btn">
		                  <button class="btn btn-default" type="button" onclick="fileImports.click()">选择文件</button>
		               </span>
		            </div>
				</div>
			</div>
...
<script type="text/javascript" src="dist/js/QueryAnalysis/FlowQuery.js"></script>
