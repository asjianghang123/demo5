		...
		<div class="col-sm-12">
			...
			<div class='box'>
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <a id="exportvolte" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="doSearchbadCell('filevolte','高掉线小区')"><span class="ladda-label">导出</span></a>
                    </div>
				</div>
				<div class="box-body">
					<div class="table-responsive">
										...
										<div class="panel-group">
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion" 
														   href="#collapseFive1" style="padding-left: 10px;">
		...
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
	            ...
	            <div class="modal-body">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs pull-left">
                            <li class="active"><a href="#baselineTableDiv_0" data-toggle="tab">mod3重叠覆盖</a></li>
                            <li><a href="#baselineTableDiv_1" data-toggle="tab">PCI一阶冲突</a></li>
                            <li><a href="#baselineTableDiv_2" data-toggle="tab">PCI二阶冲突</a></li>
                            <li><a href="#baselineTableDiv_3" data-toggle="tab">小区freqrel</a></li>
                            <li><a href="#baselineTableDiv_4" data-toggle="tab">邻区问题</a></li>
                            <li><a href="#baselineTableDiv_5" data-toggle="tab">A类参数配置不一致</a></li>
                        </ul>
                        <div class="tab-content">
...
<script type="text/javascript" src="dist/js/badCellAnalysis/highLostCell.js"></script>
