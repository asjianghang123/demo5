	...
	<div class="col-sm-12">
		<div class="box">
			...
			<div class='box-footer' style="text-align:right">
				...
				<input id="badCellFileNBM" value='' hidden="true" />	
		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
					<a id="exportNBI" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="doSearchbadCell('filenbm','切换差小区')"><span class="ladda-label">导出</span></a>
				</div>
			</div>
			<div class="box-body">
				<div class="table-responsive">
					<table id="badCellTableNBI">
					</table>
				</div>
			</div>	
		</div>
		<div class="box">
			...
			<div class="row">
														...
														<div class="form-group" style="margin: 0">
															...
															<div class="col-sm-7">
														     ...
														     <div id="AvgPRB_head" style="display: none">
														    	<label id="AvgPRB_lab" class="col-sm-8 control-label" style="text-align: center;"></label>
														     </div>
														</div>
													</form>
												</div>
												...
												<div class="panel-body">														
													<form class="form-horizontal">
														<div class="form-group" style="margin: 0;">
														    ...
														    <label for="avgTA" class="col-sm-7 control-label" style="text-align: center;">平均TA:</label>
															<div class="col-sm-5">
									...
									<div class="panel-group">
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" 
													   href="#collapseFore" style="padding-left: 10px;">
														<span id='parameterNum' style="left: 24px;top: 11px; position: absolute;"></span>参数
													</a>
												</h4>
											</div>
											<div id="collapseFore" class="panel-collapse collapse in">
												<div class="panel-body">														
													<form class="form-horizontal">
														<div class="form-group">
									...
									<div class="panel-group">
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" 
													   href="#collapseEight" style="padding-left: 10px;">
				...
				<div class="col-md-6">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">准备失败原因值分布</h3>
				...
				<div class="col-md-6">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">执行失败原因值分布</h3>
							<div class="btn-div pull-right">
								<div class="btn-group">
		...
		<div class="box"><!--0524-->
			<div class="box-header">
				<h3 class="box-title">邻区关系</h3>
			</div>
			<div class="box-body">
				<table id="neighBadHandoverCellTable"></table>
				<div class="zhaozi" id="neighBadHandoverCellTable_zhaozi"></div>
				<div class="loadingImg text-center" id="neighBadHandoverCellTable_loadingImg">
					<span><i class="fa fa-spinner fa-pulse fa-fw"></i>加载中，请稍等</span>
				</div>
			</div>
		</div>
                        		...
                        		<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control" id="worstCellChartPrimaryAxisType" multiple="multiple" hidden="hidden">
											<option value="切换成功率" selected="selected" disabled="disabled">切换成功率</option>
											<option value="准备切换成功率" selected="selected" disabled="disabled">准备切换成功率</option>
											<option value="执行切换成功率" selected="selected" disabled="disabled">执行切换成功率</option>
										</select>
									</div>
	...
	<div class="modal fade" id="config_information">
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
				...
				<div class="modal-body text-center row" style="margin-left:150px;">
		...
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
	            ...
	            <div class="modal-body">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs pull-left">
                            <li class="active"><a href="#baselineTableDiv_0" data-toggle="tab">PCI一阶冲突</a></li>
                            <li><a href="#baselineTableDiv_1" data-toggle="tab">PCI二阶冲突</a></li>
                            <li><a href="#baselineTableDiv_2" data-toggle="tab">MME LIST定义不一致</a></li>
                            <li><a href="#baselineTableDiv_3" data-toggle="tab">X2 Used IP检查</a></li>
                            <li><a href="#baselineTableDiv_4" data-toggle="tab">X2 邻区eNbID检查</a></li>
                            <li><a href="#baselineTableDiv_5" data-toggle="tab">ActivePLMNlist为空</a></li>
                            <li><a href="#baselineTableDiv_6" data-toggle="tab">邻区外部定义不一致的邻区</a></li>
                            <li><a href="#baselineTableDiv_7" data-toggle="tab">TAC割接</a></li>
                            <li><a href="#baselineTableDiv_8" data-toggle="tab">4G测量频点数量多于5</a></li>
                            <li><a href="#baselineTableDiv_9" data-toggle="tab">baseline中A类参数配置</a></li>
                            <li><a href="#baselineTableDiv_10" data-toggle="tab">内外部SNlength检查(12,10)</a></li>
                            <li><a href="#baselineTableDiv_11" data-toggle="tab">A5频率偏移核查1</a></li>
                            <li><a href="#baselineTableDiv_12" data-toggle="tab">A5频率偏移核查2</a></li>
                            <li><a href="#baselineTableDiv_13" data-toggle="tab">B2频率偏移核查1</a></li>
                            <li><a href="#baselineTableDiv_14" data-toggle="tab">B2频率偏移核查2</a></li>
                        </ul>
                        <div class="tab-content">
	...
	<div class="modal-dialog" style="width:900px;">
		<div class="modal-content">
			<div class="modal-header">
                ...
                <h8 class="modal-title" id="mtitle">准备失败原因值分布详情<span id="loading"></span></h8>
            </div>
...
<!-- 执行阶段详情弹出框-->
<div class="modal fade" id="config_information_execResultDetail">
	<div class="modal-dialog" style="width:900px;">
		<div class="modal-content">
			<div class="modal-header">
				<div class="box-tools pull-right">
					<a id="exportExecDetail" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="exportExecDetail()"><span class="ladda-label">导出</span></a>&nbsp;&nbsp;
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                	<span aria-hidden="true">&times;</span>
	                </button>
                </div>
                <h8 class="modal-title" id="mtitle">执行失败原因值分布详情<span id="loading"></span></h8>
            </div>
			<form class="form-horizontal" role="form" id="scopeForm">
				<div class="modal-body text-center">
					<table id="execResultDetailTable">
					</table>
				</div>
			</form>
		</div>
							...
							<div class="box-body">
	                            <table border="1px" style="font-size:14px;border:0.2px solid gray;">
	                                ...
	                                <tr>
	                                    ...
	                                    <td align='center' width="240px">切换成功率</td>
...
<style type="text/css"> 
    ...
    #alarmNum,#LteNum,#GsmNum,#weakCoverNum,#highInterfereNum,#erbsAlarmNum,#overlapCeakCoverNum,#firstOrderConflictNum,#secondOrderConflictNum,#erbsAlarmNumHour,#alarmNumHour,#highInterfereNumHour,#prbHighInterfereNumHour,#prbHighInterfereNum{
	   border:0;
		...
		#currentAlarm,#needAddNeigh,#less116Proportion,#less155Proportion,#overlapCover,#AvgPRB,#highTraffic,#parameter,#wirelessCallRate_interfere,#cqi,#featureState,#licenseState,#avgTA,#wirelessCallRate_zhicha,#wirelessCallRate_RRCEstSucc,#wirelessCallRate_ERABEstSucc{
	   border:0;
...
<script type="text/javascript" src="dist/js/badCellAnalysis/badHandoverCell.js"></script>
