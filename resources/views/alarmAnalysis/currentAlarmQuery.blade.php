	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="box">
	            ...
	            <div class="box-body">
	            	<table id="currentAlarmTable"> 
	            	</table>
	            </div>
				<!-- <div class="box-body" style="height:600px;overflow:auto;">
					<table id="currentAlarmTable"></table>
				</div> -->
			</div>
...
<script type="text/javascript" src="dist/js/alarmAnalysis/currentAlarmQuery.js"></script>
