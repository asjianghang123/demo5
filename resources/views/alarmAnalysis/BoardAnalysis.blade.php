			...
			<div class="box">
				...
				<div class='box-body'>
					<div class="row">
						...
						<div class="col-md-3">
							<select name="" id="boardType" class="form-control input-sm" >
								<option value="du">DU板卡</option>
								<option value="rru">RRU板卡</option>
							</select>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="dist/js/alarmAnalysis/BoardAnalysis.js"></script>
