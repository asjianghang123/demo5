		...
		<div class="col-sm-12">
			<div class="box">
				...
				{{-- 	<ul class="nav nav-tabs" role="tablist">
						<li class="active"><a href="#table_tab_0" data-toggle="tab" onClick="switchTab('LteCurrent')"
							aria-expanded="false">当前告警查询</a></li>
						<li class=""><a href="#table_tab_1" data-toggle="tab" onClick="switchTab('LteHistory')"
							aria-expanded="false">历史告警查询</a></li>
					</ul> --}}
				</div>
				<div class="box-body">
					<form class="form-horizontal" role="form" id="queryForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="" id="LteAlarm" class="form-control input-sm">
									<option value="LteCurrent">当前</option>
									<option value="LteHistory">历史</option>
								</select>
								
							</div>
							<label class = "col-sm-1 control-label" >制式</label>
							<div class="col-sm-2">
								<select name="" id="SubNet" class="form-control">
							...
							<div class="col-sm-2 checkbox">
								<input id='regionalDimension' checked data-toggle="toggle" data-on="基站" data-off="小区" data-onstyle="info" data-offstyle="success" data-width="200" data-size="mini" type="checkbox">
							</div>
						</div>
						<div class="form-group">
						...
						<div id="LteTime" style="display: none;">
			...
			<div class="box">
	            ...
	            <div class="box-body">
	            	<input type="hidden" value="LteCurrent" id="LteAlarmManage">
	            	<table id="LteAlarmTable"> 
	            	</table>
	            </div>
...
<script type="text/javascript" src="dist/js/alarmAnalysis/LteAlarmQuery.js"></script>
