		...
		<div class="col-sm-12">
			<div class="box">
				...
				{{-- 	<ul class="nav nav-tabs" role="tablist">
						<li class="active"><a href="#table_tab_0" data-toggle="tab" onClick="switchTab('GSMCurrent')"
							aria-expanded="false">当前告警查询</a></li>
						<li class=""><a href="#table_tab_1" data-toggle="tab" onClick="switchTab('GSMHistory')"
				...
				<div class="box-body">
					<form class="form-horizontal" role="form" id="queryForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="" id="GSMAlarm" class="form-control input-sm">
									<option value="GSMCurrent">当前</option>
									<option value="GSMHistory">历史</option>
								</select>
						...
						<div class="form-group" id="GSMTime" style="display: none">
			...
			<div class="box">
	            ...
	            <div class="box-body">
	            	<input type="hidden" value="GSMCurrent" id="GSMAlarmManage">
	            	<table id="GSMAlarmTable"> 
	            	</table>
	            </div>
...
<script type="text/javascript" src="dist/js/alarmAnalysis/GSMAlarmQuery.js"></script>
