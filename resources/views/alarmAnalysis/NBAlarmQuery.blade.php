	...
	<div class="row">
		<div class="col-sm-12">
				...
				<div class="box-body">
					<form class="form-horizontal" role="form" id="queryForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="" id="NBAlarm" class="form-control input-sm">
									<option value="NBCurrent">当前</option>
									<option value="NBHistory">历史</option>
								</select>
						...
						<div class="form-group" id="NBTime" style="display: none;">
			...
			<div class="box">
	            ...
	            <div class="box-body">
	            	<input type="hidden" value="NBCurrent" id="NBAlarmManage">
	            	<table id="NBAlarmTable"> 
	            	</table>
	            </div>
...
<script type="text/javascript" src="dist/js/alarmAnalysis/NBAlarmQuery.js"></script>
