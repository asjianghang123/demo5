...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li>
			<i class="fa fa-dashboard"></i>用户分析
		</li>
		<li>信令回溯</li>
		<li class="active">NAS信令回溯</li>
	</ol>
</section>
@endsection
@section('content')
			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="btn-div pull-right">
		                <div class="btn-group">
		                    <a type="button" class="btn btn-default ladda-button" data-style="expand-right" onclick="exportProcess()" id="exportBtn">
...
<script type="text/javascript" src="dist/js/complaintHandling/NASSignalingBacktrack.js"></script>
