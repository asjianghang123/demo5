				...
				<div class="box-body">
					<!-- <div class="row"> -->
						<form class="form-horizontal" role="form" id="queryForm">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="moTableFields">属性</label>
								<div class="col-sm-4">
									<select id="moTableFields" class="js-example-basic-single js-states form-control input-md" multiple="multiple">
									</select>
								</div>
								<label class="col-sm-2 control-label" for="featureList" id="Feature_label">Feature</label>
								<div class="col-sm-4" id="Feature_div">
									<select id="featureList" class="js-example-basic-single js-states form-control input-md" multiple="multiple">
									</select>
								</div>
							</div>
