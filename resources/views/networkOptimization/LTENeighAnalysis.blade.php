...
<div class="col-sm-12">
	<div class="box">
		...
		<div class='box-footer' style="text-align:right;">
			...
			<!-- <a id="importWhiteList" type="submit"  class="btn btn-primary ladda-button" onclick="importWhiteList('MRE');return false;">导入白名单</a>
            <a id="exportWhiteList" type="submit"  class="btn btn-primary ladda-button" onclick="exportWhiteList('MRE');return false;">导出白名单</a> -->
			...
			<!-- <div hidden="true">
			  ...
			  <!-- data-toggle="tooltip" data-placement="bottom" title="导出所有数据" -->
		</div>	
	</div>
	<div class="box">
		<div class="box-header with-border">
...
<script type="text/javascript" src="dist/js/NetworkOptimization/LTENeighAnalysis.js"></script>
