...
<section class="content-header">
	<h1>新站跟踪<!-- <small>advanced tables</small> --></h1>
	<ol class="breadcrumb">
		<li><i class="fa fa-thumbs-up feature"></i>定制
		</li>
		<li>参数
		</li>
		<li class="active">新站跟踪</li>
	</ol>
</section>
@endsection
@section('content')
		...
		<div class="col-sm-12">
			<div class="box" >
				...
				<div class="box-footer">
					<div style="text-align:right;">
						<a id="search" class="btn btn-primary ladda-button"  href="#" role="button" onClick="newSiteSearch()" data-color='red' data-style="expand-right" ><span class="ladda-label">查询</span></a>
			...
			<div class="box">
				<div class="box-header  with-border">
                    ...
                    <div class="box-tools pull-right">
                   	 	<!-- <a id="export" class="btn btn-primary ladda-button"  href="#" role="button" onClick="newSiteExport();return false;" data-color='red' data-style="expand-right" ><span class="ladda-label">获取kget</span></a>
						<a id="export" class="btn btn-primary ladda-button"  href="#" role="button" onClick="newSiteExport();return false;" data-color='red' data-style="expand-right" ><span class="ladda-label">获取STS</span></a> -->
                    	<a id="newSiteImport" class="btn btn-primary ladda-button"  href="#" role="button" onClick="newSiteImport()" data-color='red' data-style="expand-right" ><span class="ladda-label">导入</span></a>
                   		<a id="newSiteExport" class="btn btn-primary ladda-button"  href="#" role="button" onClick="newSiteExport()" data-color='red' data-style="expand-right" ><span class="ladda-label">导出模板</span></a>
...
<script type="text/javascript" src="dist/js/SpecialFunction/newSite.js"></script>
