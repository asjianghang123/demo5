													...
													<div class="panel-body">
														<form class="form-horizontal">
															<div class="form-group">
															    ...
															    <label for="4GneedAddNeigh" class="col-sm-7 control-label" style="text-align: center;">4G邻区数量:</label>
																<div class="col-sm-5">
		...
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
	            ...
	            <div class="modal-body">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs pull-left">
                            <li class="active" id="chanshu0" ><a href="#baselineTableDiv_0" data-toggle="tab">邻区过少</a></li>
                            ...
                            <li id="chanshu18" ><a href="#baselineTableDiv_18" data-toggle="tab">增强相关功能未开</a></li>
...
<script type="text/javascript" src="dist/js/VolteCellAnalysis/voltedownbadcell.js"></script>
