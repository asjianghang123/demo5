													...
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion" 
														   href="#collapseTwo" style="padding-left: 10px;">
															<span id='AvgPRBNum' style="left: 24px;top: 11px; position: absolute;"></span>上行干扰
														</a>
													</h4>
												</div>
												<div id="collapseTwo" class="panel-collapse collapse in">
													<div class="panel-body">
														<form class="form-horizontal" style="word-break: keep-all;white-space: nowrap;">
															<label for="AvgPRB" class="col-sm-5 control-label" style="text-align: center;">平均PRB:</label>
														      	<input type="text" id="AvgPRB" readonly="readonly" style="width: 100px;height:20px;top: 30px">
														</form>
													</div>
												</div>
											</div>
													...
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion" 
														   href="#collapseThree" style="padding-left: 10px;">
															<span id='less116ProportionNum' style="left: 24px;top: 11px; position: absolute;"></span>下行覆盖
														</a>
													</h4>
												</div>
												<div id="collapseThree" class="panel-collapse collapse in">
													<div class="panel-body">														
														<form class="form-horizontal"> 
														    ...
														    <input type="text" id="less116Proportion" readonly="readonly" style="border: none;text-align: center;">
														</form>
													</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div id="collapseSix" class="panel-collapse collapse in">
													<div class="panel-body">
														<form class="form-horizontal">
															<div class="form-group">
																<label for="2GneedAddNeigh" class="col-sm-7 control-label" style="text-align: center;">2GMRE补邻区数:</label>
																<div class="col-sm-5">
															      	<input type="text" id="2GneedAddNeigh" readonly="readonly" style="border: none;width: 60px;height:20px">
															    </div>
															    <label for="4GneedAddNeigh" class="col-sm-7 control-label" style="text-align: center;">4GMRE补邻区数:</label>
																<div class="col-sm-5">
															      	<input type="text" id="4GneedAddNeigh" readonly="readonly" style="border: none;width: 60px;height:20px">
															    </div>
															</div>
														</form>
													</div>
													...
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion" 
														   href="#collapseThree_2" style="padding-left: 10px;">
															<span id='resourcenum' style="left: 24px;top: 11px; position: absolute;"></span>调度资源
														</a>
													</h4>
												</div>
												<div id="collapseThree_2" class="panel-collapse collapse in">
													<div class="panel-body" style="height:99px">		
														<form class="form-horizontal">
															<div class="form-group">
																<div class="col-sm-12" style="word-break: keep-all;white-space: nowrap;">
																	<label for="resource" style="text-align: center;font-weight: normal;">pmPucchFailSr/pmPucchSr:</label>
																    <input type="text" id="resource" readonly="readonly" style="border: none;width: 60px;height:20px">
																</div>
															</div>
														</form>
													</div>
										...
										<div class="panel-group">
											<div class="panel panel-default">
													...
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion" 
														   href="#collapseThree_3" style="padding-left: 10px;">
															<span id='downcovernum' style="left: 24px;top: 11px; position: absolute;"></span>上行覆盖
														</a>
													</h4>
												</div>
												<div id="collapseThree_3" class="panel-collapse collapse in">
													<div class="panel-body" style="height:99px">		
														<form class="form-horizontal">
															<div class="form-group" style="word-break: keep-all;white-space: nowrap;">
																<div class="col-sm-12">
																	<label for="pusch" style="text-align: center;font-weight: normal;">PUSCH-SINR低于-5dB的比例:</label>
																	<input type="text" id="pusch" readonly="readonly" style="border: none;width: 60px;height:20px">
																</div>
														    	{{-- <input type="text" id="pusch" readonly="readonly" style="border: none;"> --}}
														    	<div class="col-sm-12" style="word-break: keep-all;white-space: nowrap;">
																    <label for="pucch" style="text-align: center;font-weight: normal;">PUCCHSINR低于-15的的比例:</label>
																    <input type="text" id="pucch" readonly="readonly" style="border: none;width: 60px;height:20px">
																</div>
															</div>
														</form>
													</div>
		...
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
	            ...
	            <div class="modal-body">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs pull-left">
                            <li id="chanshu0" ><a href="#baselineTableDiv_0" data-toggle="tab">邻区过少</a></li>
                            <li id="chanshu1" ><a href="#baselineTableDiv_1" data-toggle="tab">SN length参数设置错误</a></li>
                            <li id="chanshu2" ><a href="#baselineTableDiv_2" data-toggle="tab">没有定义同频站点</a></li>
                            <li id="chanshu3" ><a href="#baselineTableDiv_3" data-toggle="tab">未定邻区 </a></li>
                            <li id="chanshu4" ><a href="#baselineTableDiv_4" data-toggle="tab">没有定义2G邻区</a></li>
                            <li id="chanshu5" ><a href="#baselineTableDiv_5" data-toggle="tab">没有定义本小区freqrel</a></li>
                            <li id="chanshu6" ><a href="#baselineTableDiv_6" data-toggle="tab">一阶冲突</a></li>
                            <li id="chanshu7" ><a href="#baselineTableDiv_7" data-toggle="tab">二阶冲突</a></li>
                            <li id="chanshu8" ><a href="#baselineTableDiv_8" data-toggle="tab">外部2G小区定义错误</a></li>
                            <li id="chanshu9" ><a href="#baselineTableDiv_9" data-toggle="tab">外部4G小区定义错误</a></li>
                            <li id="chanshu10" ><a href="#baselineTableDiv_10" data-toggle="tab">MRE排名前20名的小区mod3重叠覆盖</a></li>
                            <li id="chanshu11" ><a href="#baselineTableDiv_11" data-toggle="tab">baseline中A类参数配置不一致的</a></li>
                            <li id="chanshu12" ><a href="#baselineTableDiv_12" data-toggle="tab">TCPO</a></li>
                            <li id="chanshu13" ><a href="#baselineTableDiv_13" data-toggle="tab">HARQ次数</a></li>
                            <li id="chanshu14" ><a href="#baselineTableDiv_14" data-toggle="tab">RLC reordering参数</a></li>
                            <li id="chanshu15" ><a href="#baselineTableDiv_15" data-toggle="tab">DU基站</a></li>
                            <li id="chanshu16" ><a href="#baselineTableDiv_16" data-toggle="tab">Baseband-based 基站</a></li>
                            <li id="chanshu17" ><a href="#baselineTableDiv_17" data-toggle="tab">PDCCH符号数设置低于2</a></li>
                            <li id="chanshu18" ><a href="#baselineTableDiv_18" data-toggle="tab">增强相关功能DU</a></li>
                            <li id="chanshu19" ><a href="#baselineTableDiv_19" data-toggle="tab">A5频率偏移核查1</a></li>
                            <li id="chanshu20" ><a href="#baselineTableDiv_20" data-toggle="tab">A5频率偏移核查2</a></li>
                            <li id="chanshu21" ><a href="#baselineTableDiv_21" data-toggle="tab">B2频率偏移核查1</a></li>
                            <li id="chanshu22" ><a href="#baselineTableDiv_22" data-toggle="tab">B2频率偏移核查2</a></li>
                            <li id="chanshu23" ><a href="#baselineTableDiv_23" data-toggle="tab">增强相关功能Baseband-based</a></li>
                        </ul>
                        <div class="tab-content">
                        	...
                        	<div class="chart tab-pane" id="baselineTableDiv_9">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_9">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_10">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_10">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_11">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_11">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_12">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_12">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_13">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_13">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_14">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_14">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_15">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_15">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_16">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_16">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_17">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_17">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_18">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_18">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_19">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_19">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_20">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_20">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_21">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_21">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_22">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_22">
								</table>
                        	</div>
                        	<div class="chart tab-pane" id="baselineTableDiv_23">
                        		<table class="table baselineTableIndex" id="baselineTableIndex_23">
								</table>
                        	</div>
                        </div>
					</div>
...
<script type="text/javascript" src="dist/js/VolteCellAnalysis/volteupbadcell.js"></script>
