...
function doSearchbadCell(table) {
	...
	$.get("volteupbadcell/templateQuery", params, function(data){
		var fieldArr=[];
...
function alarm(cell, city) {
	...
	$.ajax({
		type:"get",
		url:"volteupbadcell/getcurrentAlarmNum",
		data: params,
		dataType:"json",
		async : false,
		success:function(data){
...
function cover(cell, city) {
	...
	$.ajax({
		type:"get",
		url:"volteupbadcell/overlapcover",
		data: params,
		dataType:"json",
		async : false,
		success:function(data){
...
function getAllCity(){
	...
	var url = "volteupbadcell/getAllCity";
	$.ajax({
		type:"GET",
		url:url,
		dataType:"json",
...
function report(cell) {
	...
	$.ajax({
		type:"get",
		url:"volteupbadcell/getReportData",
		data: params,
		dataType:"json",
		async : false,
		success:function(data){
...
function getCTRJump(record) {
    ...
    $.post("volteupbadcell/ctrTreeItems", params, function (data) {
    	S.stop();
        // var returnData = JSON.parse(data);
        $("#ctrData").html("");
        $("#ctrData").append(data);
...
function storage() {
	...
	$.post("volteupbadcell/storage", params, function (data) {
		if (data) {
			path = data;
			if (type == "ctr") {
				$("#ctrTypeDiv").show();
