...
function searchLTEQuery() {
	...
	var url = "LTEQueryLocal/searchLTETreeData";
	//var treeData;

	$.get("LTEQueryLocal/searchLTETreeData", params, function (data) {
		console.log(data);
		//data = "["+data+"]";
...
function getFormatAllSubNetwork() {
	...
	$.get("LTEQueryLocal/getFormatAllSubNetwork", params, function (data) {
		var newOptions = [];
		var obj = {};
...
function getAllSubNetwork() {
	...
	$.get("LTEQueryLocal/getAllSubNetwork", params, function (data) {
		var newOptions = [];
		var obj = {};
		$(data).each(function (k, v) {
			v = eval("(" + v + ")");
...
function getAllCity() {
	...
	var url = "LTEQueryLocal/getAllCity";
	$.ajax({
		type: "GET",
		url: url,
		dataType: "json",
...
function getTree() {
	var url = "LTEQueryLocal/getLTETreeData";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
...
function doSearchLTE(table) {
	...
	var route;
	if (flag) {
		route = "LTEQueryLocal/templateQueryOnline";
		...
		route = "LTEQueryLocal/templateQueryLocal";
	}
	...
	var xhr = $.ajax({
		type: "POST",
		url: "LTEQueryLocal/templateQuery",
		data: params,
		success: function (data) {
			// $("#search").on("click", function () {
			// 	doSearchLTE("table");
...
function getElementTree(id) {
	...
	var url = "LTEQueryLocal/getElementTree";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
...
function getKpiNamebyId(id) {
	var url = "LTEQueryLocal/getKpiNamebyId";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
