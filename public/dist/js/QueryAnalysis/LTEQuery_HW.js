...
function searchLTEQuery() {
	...
	var url = "LTEQueryHW/searchLTETreeData";
	//var treeData;

	$.get("LTEQueryHW/searchLTETreeData", params, function (data) {
		console.log(data);
		//data = "["+data+"]";
...
function getFormatAllSubNetwork() {
	...
	$.get("LTEQueryHW/getFormatAllSubNetwork", params, function (data) {
		var newOptions = [];
		var obj = {};
...
function getAllSubNetwork() {
	...
	$.get("LTEQueryHW/getAllSubNetwork", params, function (data) {
		var newOptions = [];
		var obj = {};
		$(data).each(function (k, v) {
			v = eval("(" + v + ")");
...
function getTree() {
	var url = "LTEQueryHW/getLTETreeData";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
...
function doSearchLTE(table) {
	...
	var route;
	if (flag) {
		route = "LTEQueryHW/templateQueryOnline";
		...
		route = "LTEQueryHW/templateQueryLocal";
	}
	...
	}, setPDOSearchTime("LTEQueryHW"));


	var xhr = $.ajax({
		type: "POST",
		url: "LTEQueryHW/templateQuery",
		data: params,
		success: function (data) {
			// $("#search").on("click", function () {
			// 	doSearchLTE("table");
...
function getElementTree(id) {
	...
	var url = "LTEQueryHW/getElementTree";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
...
function getKpiNamebyId(id) {
	var url = "LTEQueryHW/getKpiNamebyId";
	var treeData;
	$.ajax({
		type: "GET",
		url: url,
