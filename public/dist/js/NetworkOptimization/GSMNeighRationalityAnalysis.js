$(document).ready(function () {
	setTime();
	//getAllDatabase();
	toogle("GSMNeighRationalityAnalysis");
...
function searchGSM() {
	GSMNeighRationalitySearch();
}
function GSMNeighRationalitySearch() {
	var dateTime = $("#dateTime").val();
	var url = "GSMNeighRationality/GSMNeighRationalityDistribute";
	chart_column(url, {"dateTime": dateTime}, "#chart-gsmNeighRation");
}
