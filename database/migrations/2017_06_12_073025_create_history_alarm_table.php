...
class CreateHistoryAlarmTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('alarm')->create('FMA_alarm_log', function (Blueprint $table) {
            $table->dateTime('insert_time');
            $table->integer('log_serial_number');
    ...
    {
        Schema::connection('alarm')->drop('FMA_alarm_log');
    }
}
