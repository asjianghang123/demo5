...
class CreateMreServeNeighsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('MR_CZ')->create('mreServeNeigh', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection('MR_CZ')->dropIfExists('mreServeNeigh');
    }
}
