...
class CreateRelationNonHandoversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('autokpi')->create('RelationNonHandover', function (Blueprint $table) {
    ...
    {
        Schema::connection('autokpi')->dropIfExists('RelationNonHandover');
    }
}
